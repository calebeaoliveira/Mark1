...
if (!empty($_REQUEST['txt_pesquisa'])) {
        ...
        $sql = "select * from tb_pratos where PRA_DESCRICAO='$pesquisa'";
}
     else {
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li><a href="cadastro_pratos.php">Pratos</a></li>
                    </ul>
                </li>
                <li>
                <a href="#"><i class="fa fa-table"></i> <span class="nav-label">Consultas </span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li>
                            <a href="consulta_pratos.php">Pratos <span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                                    <a href="consulta_pratos.php">Por Descrição</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <div class="col-sm-12">
                    <div class="ibox">
                        <div class="ibox-content">
                            <h2>Pratos</h2>
                            <p>
                                Consultar os pratos por descrição.
                            </p>
                            <form method="post" action="consulta_pratos.php">
                            <div class="input-group">
                                <input type="text" placeholder="Pesquisar pratos " class="input form-control" name="txt_pesquisa">
                            ...
                            <?php
							$cmd = "SELECT * FROM tb_pratos";
							$itens = mysqli_query($con, $cmd);
							$total = mysqli_num_rows($itens);
							?>
                            <span class="float-right small text-muted"><?php echo $total ?> Pratos</span><br>
                                    ...
                                    <div class="full-height-scroll">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover">
                                                ...
                                                <tr>
                                                    <td><?php echo $dados['PRA_CODIGO'];?></td>
                                                    <td><?php echo $dados['PRA_DESCRICAO'];?></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td><a href="delete.php?PRA_CODIGO=<?php echo $dados['PRA_CODIGO']; ?>"> 
        	                                            <img src="../img/excluir.png"> 
      		                                        </a> </td>
                                                    <td><a href="form_atualizar.php?PRA_CODIGO=<?php echo $dados['PRA_CODIGO']; ?>"> 
