    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level collapse">
                        <li><a href="cadastro_clientes.php">Clientes</a></li>	
                    ...
                    <ul class="nav nav-second-level collapse">
                        <li>
                            ...
                            <ul class="nav nav-third-level">
                                <li>
                                    <a href="consulta_cliente.php">Por Nome</a>
                                </li>
                            </ul>
                        </li>
                        <li>
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
          ...
          <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
                <div class="col-lg-12">
                     <form method="post" style="height:100%;" action="atualizar.php">
                     <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Código</label>
            	<div class="col-sm-10"><input type="text" class="form-control" name="txt_codigo" value="<?php echo $dados['CLI_CODIGO'];?>" readonly></div>
            </div>
             <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Nome</label>
            	<div class="col-sm-10"><input type="text" class="form-control" name="txt_nome" value="<?php echo $dados['CLI_NOME'];?>"></div>
            </div>
            <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">E-mail</label>
            	<div class="col-sm-10"><input type="text" class="form-control" name="txt_email" value="<?php echo $dados['CLI_EMAIL'];?>"></div>
            </div>
            <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Endereço</label>
            	<div class="col-sm-10"><input type="text" class="form-control" name="txt_endereco" value="<?php echo $dados['CLI_ENDERECO'];?>"></div>
            </div>
            <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Número</label>
            	<div class="col-sm-10"><input type="text" class="form-control" name="txt_numero" value="<?php echo $dados['CLI_NUMERO'];?>"></div>
            </div>
            <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Complemento</label>
            	<div class="col-sm-10"><input type="text" class="form-control" name="txt_complemento" value="<?php echo $dados['CLI_COMPLEMENTO'];?>"></div>
            </div>
            <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Bairro</label>
            	<div class="col-sm-10"><input type="text" class="form-control" name="txt_bairro" value="<?php echo $dados['CLI_BAIRRO'];?>"></div>
            </div>
            <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">UF</label>
            	<div class="col-sm-10"><select class="form-control m-b" name="sel_uf">
                                        <option></option>
            ...
            <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Cidade</label>
            	<div class="col-sm-10"><input type="text" class="form-control" name="txt_cidade" value="<?php echo $dados['CLI_CIDADE'];?>"></div>
            </div>
             <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Telefone</label>
            	<div class="col-sm-10"><input type="text" class="form-control" name="txt_telefone" value="<?php echo $dados['CLI_TELEFONE'];?>"></div>
            </div>
             <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Sexo</label>
            	<div class="col-sm-10"><select class="form-control m-b" name="sel_sexo">
                                        <option></option>
