...
if (!empty($_REQUEST['txt_pesquisa'])) {
        ...
        $sql = "select * from tb_clientes where CLI_NOME='$pesquisa'";
}
     else {
                ...
                <div class="col-sm-12">
                    <div class="ibox">
                        <div class="ibox-content">
                            <h2>Clientes</h2>
                            <p>
                                Consultar os clientes por nome.
                            </p>
                            <form method="post" action="../clientes/consulta_cliente.php">
                            <div class="input-group">
                                <input type="text" placeholder="Pesquisar cliente " class="input form-control" name="txt_pesquisa">
							...
							?>
                            <span class="float-right small text-muted"><?php echo $total ?> Clientes</span><br>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="delete.php?CLI_CODIGO=<?php echo $dados['CLI_CODIGO']; ?>"> 
        	                                            <img src="../img/excluir.png"> 
      		                                        </a> </td>
                                                    <td><a href="form_atualizar.php?CLI_CODIGO=<?php echo $dados['CLI_CODIGO']; ?>"> 
