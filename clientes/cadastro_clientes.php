        ...
        <div class="row wrapper border-bottom white-bg page-heading">
          ...
          <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Cidade</label>
            	<div class="col-sm-10"><input type="text" placeholder="Digitar sem acentos!" class="form-control" name="txt_cidade"></div>
            </div>
             <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Telefone</label>
            	<div class="col-sm-10"><input type="text" class="form-control" data-mask="(99) 99999-9999" placeholder="" name="txt_telefone"></div>
            </div>
            ...
            <!--Checkboxes -->
            <div class="col-sm-10" style="margin-top:2%;width:auto;float:left;">
              <div><label> <input type="checkbox" value="On" name="ciente"> Li e concordo com <a href="../pdf/politica_de_privacidade.pdf">a politica de privacidade.</a></label></div>
             </div>
