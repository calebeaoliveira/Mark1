        ...
        <div class="row wrapper border-bottom white-bg page-heading">
          ...
          <div class="row">
                <div class="col-sm-12">
                    ...
                    <!--Cadastrar cardápio-->
            <form method="post" style="height:100%;" action="../cardapio/salvar_cad_cardapio.php">
                     
            <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Data do Cardápio</label>
            	<div class="col-sm-10"><input type="date" class="form-control" name="txt_data"></div>
            </div>
            <div class="hr-line-dashed"></div>

                                    <div class="col-sm-offset-2" style="float:right;">
                                        
                                        <button class="btn btn-primary btn-sm" type="submit">Criar cardápio</button><br><br>
