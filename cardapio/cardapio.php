...
$sql = "select * from tb_cardapio where CDP_CODIGO = (select max(CDP_CODIGO) from tb_cardapio)";
$sql = mysqli_query ($con, $sql) or die ("Erro na sql!");
$dados = mysqli_fetch_array($sql);


$sql2 = "select * from tb_pratos";
$sql2 = mysqli_query ($con, $sql2) or die ("Erro na sql2!");


$sql3 = "select tb_cardapio.*,tb_itenscardapio.*,tb_pratos.*  
from tb_itenscardapio 
inner join tb_pratos on (tb_itenscardapio.PRA_CODIGO=tb_pratos.PRA_CODIGO) 
inner join tb_cardapio on (tb_itenscardapio.CDP_CODIGO=tb_cardapio.CDP_CODIGO) 
where tb_itenscardapio.CDP_CODIGO = (select max(CDP_CODIGO) from tb_cardapio)";
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
          ...
          <div class="row">
            ...
            <form method="post" style="height:100%;" action="../cardapio/add_item_cardapio.php">

            <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Código</label>
                <div class="col-sm-10"><input type="text" class="form-control" name="txt_codigo" value="<?php echo $dados['CDP_CODIGO'];?>" readonly></div>
            </div> 
            <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Data</label>
                <div class="col-sm-10"><input type="text" class="form-control" name="txt_data" value="<?php echo $dados['CDP_DATA'];?>" readonly></div>
            </div>
                     
            <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Prato</label>
            	<div class="col-sm-10"><select class="form-control m-b" name="sel_item">
                                <?php while($dados2=mysqli_fetch_array($sql2)){?>
                                        <option value="<?php echo $dados2['PRA_CODIGO'];?>"><?php echo $dados2['PRA_DESCRICAO'];?></option>
                                <?php } ?>
                                    </select></div>
            </div>
            <div class="hr-line-dashed"></div>
                ...
                <!--Consulta -->
                                    ...
                                    <div class="full-height-scroll">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover">
                                                ...
                                                <tr>
                                                    <td><?php echo $i++ ?></td>
                                                    <td><?php echo $dados3['PRA_DESCRICAO'];?></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td><a href="delete.php?ID=<?php echo $dados3['ICP_CODIGO']; ?>&&cardapio=<?php echo $dados3['CDP_CODIGO']; ?>"> 
                    ...
                    <form method="post" action="precardapio.php">
                             
                             <div class="col-sm-offset-2" style="float:right;">
                                        
                                    <button class="btn btn-primary btn-sm" type="submit">Finalizar cardápio</button><br><br>
