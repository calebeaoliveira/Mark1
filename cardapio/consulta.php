...
if (!empty($_REQUEST['txt_pesquisa'])) {
        ...
        $sql = "select * from tb_cardapio where CDP_DATA='$pesquisa'";
}
     else {
                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                            ...
                            <div class="input-group">
                                <input type="date" placeholder="Pesquisar cardapio " class="input form-control" name="txt_pesquisa">
                            ...
                            <?php
							$cmd = "SELECT * FROM tb_cardapio";
							$cardapio = mysqli_query($con, $cmd);
							$total = mysqli_num_rows($cardapio);
							?>
                            <span class="float-right small text-muted"><?php echo $total ?> Cardápios</span><br>
                                    ...
                                    <div class="full-height-scroll">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover">
                                                ...
                                                <tr>
                                                    <td><?php echo date_format(new DateTime($dados['CDP_DATA']), "d/m/Y");?></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td><a href="delete_cardapio.php?ID=<?php echo $dados['CDP_CODIGO']; ?>"> 
