...
$mes=date('m');
$dia=date('d');
$sql = "select SUM(VEN_VALOR) AS vendasmensal 
from tb_vendas  
where month(VEN_DATA) ='$mes' AND year(VEN_DATA)='$ano' ";
$sql = mysqli_query ($con, $sql) or die ("Erro na sql!");
$dados = mysqli_fetch_array($sql);

$sql2 = "select SUM(COM_VALOR) AS comprasmensal 
from tb_compras  
where month(COM_DTCOMPRA) ='$mes' AND year(COM_DTCOMPRA)='$ano' ";
$sql2 = mysqli_query ($con, $sql2) or die ("Erro na sql!");
$dados2 = mysqli_fetch_array($sql2);

$sql3 = "select SUM(VEN_VALOR) AS vendasanual 
from tb_vendas  
where year(VEN_DATA)='$ano' ";
$sql3 = mysqli_query ($con, $sql3) or die ("Erro na sql!");
$dados3 = mysqli_fetch_array($sql3);

$sql4 = "select SUM(COM_VALOR) AS comprasanual 
from tb_compras  
where year(COM_DTCOMPRA)='$ano' ";
$sql4 = mysqli_query ($con, $sql4) or die ("Erro na sql!");
$dados4 = mysqli_fetch_array($sql4);

$cmd = "SELECT * FROM tb_clientes";
$clientes = mysqli_query($con, $cmd);
$total = mysqli_num_rows($clientes);

$cmd2 = "SELECT * FROM tb_vendas where day(VEN_DATA)='$dia'";
$vendas = mysqli_query($con, $cmd2);
$vendasdia = mysqli_num_rows($vendas);
?>
<!DOCTYPE html>
<html>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    <a href="dashboard.php"><i class="fa fa-th-large"></i> <span class="nav-label">Painel de Controle</span></a>
                </li>
                <li>
        ...
        <div class="row">
                    <div class="col-lg-3">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <span class="label label-success float-right">Mês</span>
                                <h5>Lucro</h5>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"><?php echo 'R$ '; echo $dados['vendasmensal']-$dados2['comprasmensal']; ?></h1>
                    ...
                    <div class="col-lg-3">
                        <div class="ibox ">
                            ...
                            <div class="ibox-content">
                                <h1 class="no-margins"><?php echo 'R$ '; echo $dados3['vendasanual']-$dados4['comprasanual']; ?></h1>
                                <small>Lucro anual</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-3">
                        <div class="ibox ">
                            ...
                            <div class="ibox-content">
                                <h1 class="no-margins"><?php echo $vendasdia ?></h1>
