...
if (!empty($_REQUEST['txt_pesquisa'])) {
        ...
        $sql = "select * from tb_produtos where PRO_DESCRICAO='$pesquisa'";
}
     else {
                ...
                <div class="col-sm-12">
                    <div class="ibox">
                        <div class="ibox-content">
                            <h2>Produtos</h2>
                            <p>
                                Consultar os produtos por descrição.
                            </p>
                            <form method="post" action="../produtos/consulta_produtos.php">
                            <div class="input-group">
                                <input type="text" placeholder="Pesquisar produtos " class="input form-control" name="txt_pesquisa">
                            ...
                            <?php
							$cmd = "SELECT * FROM tb_produtos";
							$produtos = mysqli_query($con, $cmd);
							$total = mysqli_num_rows($produtos);
							?>
                            <span class="float-right small text-muted"><?php echo $total ?> Produtos</span><br>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $dados['PRO_PRECOVENDA'];?></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td><a href="delete.php?PRO_CODIGO=<?php echo $dados['PRO_CODIGO']; ?>"> 
        	                                            <img src="../img/excluir.png"> 
      		                                        </a> </td>
                                                    <td><a href="form_atualizar.php?PRO_CODIGO=<?php echo $dados['PRO_CODIGO']; ?>"> 
