    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
          ...
          <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
                <div class="col-lg-12">
                     <form method="post" style="height:100%;" action="../produtos/salvar_cad_produtos.php">
            ...
            <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Preço de venda</label>
            	<div class="col-sm-10"><input type="text" class="form-control"name="txt_precovenda"></div>
            </div>
