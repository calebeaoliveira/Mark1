...
if (!empty($_REQUEST['txt_pesquisa'])) {
        ...
        $sql = "select * from tb_procompras where PCO_DESCRICAO='$pesquisa'";
}
     else {
         $sql = "select * from tb_procompras";
        }
...
<body>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Consulta de Produtos para Compra</h2>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>Produtos para compra</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-sm-12">
                    <div class="ibox">
                        <div class="ibox-content">
                            ...
                            <p>
                                Consultar os produtos para compra por descrição.
                            </p>
                            <form method="post" action="../procompras/consulta_procompras.php">
                            <div class="input-group">
                                <input type="text" placeholder="Pesquisar produtos para compra " class="input form-control" name="txt_pesquisa">
                            ...
                            <?php
							$cmd = "SELECT * FROM tb_procompras";
							$produtos = mysqli_query($con, $cmd);
							$total = mysqli_num_rows($produtos);
							?>
                            <span class="float-right small text-muted"><?php echo $total ?> Produtos para compra</span><br>
                                    ...
                                    <div class="full-height-scroll">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover">
                                                ...
                                                <tr>
                                                    <td><?php echo $dados['PCO_CODIGO'];?></td>
                                                    <td><?php echo $dados['PCO_DESCRICAO'];?></td>
                                                    <td><?php echo $dados['PCO_PRECOCUSTO'];?></td>
                                                    <td></td>
                                                    <td><a href="delete.php?PCO_CODIGO=<?php echo $dados['PCO_CODIGO']; ?>"> 
        	                                            <img src="../img/excluir.png"> 
      		                                        </a> </td>
                                                    <td></td>
                                                    <td><a href="form_atualizar.php?PCO_CODIGO=<?php echo $dados['PCO_CODIGO']; ?>"> 
