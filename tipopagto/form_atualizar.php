<?PHP
	...
	$sql = "select * from tb_tipopagto where TPG_CODIGO ='$id'";
...
<body>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li><a href="../cadastro_tipopagto.php">Tipo de Pagamento</a></li>
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Cadastro de Tipos de Pagamento</h2>
                    <ol class="breadcrumb">
          ...
          <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
                <div class="col-lg-12">
                     <form method="post" style="height:100%;" action="../tipopagto/atualizar.php">
            <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Código</label>
            	<div class="col-sm-10"><input type="text" class="form-control" name="txt_codigo" value="<?php echo $dados['TPG_CODIGO'];?>" readonly></div>
            </div>
             <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Descrição</label>
            	<div class="col-sm-10"><input type="text" class="form-control" name="txt_descricao" value="<?php echo $dados['TPG_DESCRICAO'];?>"></div>
            </div>
