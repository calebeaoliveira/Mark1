...
if (!empty($_REQUEST['txt_pesquisa'])) {
        ...
        $sql = "select * from tb_tipopagto where TPG_DESCRICAO='$pesquisa'";
}
     else {
         $sql = "select * from tb_tipopagto";
        }
                ...
                <div class="col-sm-12">
                    <div class="ibox">
                        <div class="ibox-content">
                            ...
                            <p>
                                Consultar os tipos de pagamento por descrição.
                            </p>
                            <form method="post" action="../tipopagto/consulta_tipopagto.php">
                            <div class="input-group">
                                <input type="text" placeholder="Pesquisar tipo de pagamento " class="input form-control" name="txt_pesquisa">
                            ...
                            <?php
							$cmd = "SELECT * FROM tb_tipopagto";
							$tipopagto = mysqli_query($con, $cmd);
							$total = mysqli_num_rows($tipopagto);
							?>
                            <span class="float-right small text-muted"><?php echo $total ?> Tipos de pagamento</span><br>
                                    ...
                                    <div class="full-height-scroll">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover">
                                                ...
                                                <tr>
                                                    <td><?php echo $dados['TPG_CODIGO'];?></td>
                                                    <td><?php echo $dados['TPG_DESCRICAO'];?></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td><a href="delete.php?TPG_CODIGO=<?php echo $dados['TPG_CODIGO']; ?>"> 
        	                                            <img src="../img/excluir.png"> 
      		                                        </a> </td>
                                                    <td><a href="form_atualizar.php?TPG_CODIGO=<?php echo $dados['TPG_CODIGO']; ?>"> 
