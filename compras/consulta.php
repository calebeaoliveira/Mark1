...
if (!empty($_REQUEST['txt_data']) || !empty($_REQUEST['txt_data2'])) {
        $pesquisa = $_REQUEST['txt_data'];
        $pesquisa2 = $_REQUEST['txt_data2']; 
        $pesquisa2 = $pesquisa2.' 23:59:59';
        $sql = "select tb_compras.*,tb_fornecedor.FOR_NOME from tb_compras 
        inner join tb_fornecedor on (tb_compras.FOR_CODIGO=tb_fornecedor.FOR_CODIGO) 
        where COM_DTCOMPRA BETWEEN '$pesquisa' AND '$pesquisa2'";

        $sql4 = "select SUM(COM_VALOR) AS valortotal 
        from tb_compras 
        where COM_DTCOMPRA BETWEEN '$pesquisa' AND '$pesquisa2'";
                ...
                <div class="col-sm-12">
                    <div class="ibox">
                        <div class="ibox-content">
                            <h2>Compras</h2>
                            <p>
                                Consultar as compras por data.
                            </p>
                            <form method="post" action="../compras/consulta.php">
                            <div class="input-group">
                                <input type="date" class="input form-control" name="txt_data">
                                <input type="date" class="input form-control" name="txt_data2">
                                <span class="input-group-append">
                                        <button type="submit" class="btn btn btn-primary"> <i class="fa fa-search"></i> Pesquisar</button>
                                </span>
                            </div>
                            </form>
                            <div class="clients-list">
                            <?php
							$cmd = "SELECT * FROM tb_compras";
							$clientes = mysqli_query($con, $cmd);
							$total = mysqli_num_rows($clientes);
							?>
                            <span class="float-right small text-muted"><?php echo $total ?> Compras</span><br>
                                    ...
                                    <div class="full-height-scroll">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover">
                                                ...
                                                <tr>
                                                    <td><?php echo $dados['COM_CODIGO'];?></td>
                                                    <td><?php echo $dados['FOR_NOME'];?></td>
                                                    <td><?php echo $dados['COM_VALOR'];?></td>
                                                    <td><?php echo date_format(new DateTime($dados['COM_DTCOMPRA']), "d/m/Y");?></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td><a href="delete_compra.php?ID=<?php echo $dados['COM_CODIGO']; ?>"> 
                    ...
                    <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Total do período</label>
            	        <div class="col-sm-10"><input type="text" class="form-control" name="txt_totalcompra" value="<?php if (!empty($_REQUEST['txt_data']) || !empty($_REQUEST['txt_data2'])) {                                                                                                                                                                                                                               
                                                                                                                               echo 'R$ ' .$dados4['valortotal']; 
                                                                                                                        }
                                                                                                                            else {
                                                                                                                                echo 'R$ ';                                                                                                                                 
                                                                                                                                } ?>"></div>
