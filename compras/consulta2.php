...
if (!empty($_REQUEST['txt_pesquisa'])) {
        $pesquisa = $_REQUEST['txt_pesquisa'];
        ...
        where tb_fornecedor.FOR_NOME LIKE '%".$pesquisa."%'";

        $sql4 = "select SUM(tb_compras.COM_VALOR) AS valortotal, tb_fornecedor.FOR_NOME  
        from tb_compras 
        inner join tb_fornecedor on (tb_compras.FOR_CODIGO=tb_fornecedor.FOR_CODIGO) 
        where tb_fornecedor.FOR_NOME LIKE '%".$pesquisa."%'";
                ...
                <div class="col-sm-12">
                    <div class="ibox">
                        <div class="ibox-content">
                            ...
                            <form method="post" action="../compras/consulta2.php">
                            <div class="input-group">
                            <input type="text" placeholder="Pesquisar compras " class="input form-control" name="txt_pesquisa">
                    ...
                    <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Total do período</label>
            	        <div class="col-sm-10"><input type="text" class="form-control" name="txt_totalcompra" value="<?php if (!empty($_REQUEST['txt_pesquisa']) || !empty($_REQUEST['txt_data2'])) {                                                                                                                                                                                                                               
