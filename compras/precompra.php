...
$sql = "select tb_compras.*,tb_fornecedor.FOR_NOME
from tb_compras
inner join tb_fornecedor on (tb_compras.FOR_CODIGO=tb_fornecedor.FOR_CODIGO)";
$sql2 = "select FOR_CODIGO,FOR_NOME from tb_fornecedor";
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
          ...
          <div class="row">
                <div class="col-sm-12">
                    ...
                    <!--Cadastrar venda-->
                    <form method="post" style="height:100%;" action="../compras/salvar_cad_compra.php">
                     
            <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Fornecedor</label>
            	<div class="col-sm-10"><select class="form-control m-b" name="sel_fornecedor">
            ...
            <div class="hr-line-dashed"></div>
                                    ...
                                    <div class="col-sm-offset-2" style="float:right;">
                                        ...
                                        <button class="btn btn-primary btn-sm" type="submit">Criar compra</button><br><br>
