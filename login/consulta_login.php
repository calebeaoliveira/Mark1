...
if (!empty($_REQUEST['txt_pesquisa'])) {
        ...
        $sql = "select * from tb_login where LOG_NOME='$pesquisa'";
}
     else {
                ...
                <div class="col-sm-12">
                    <div class="ibox">
                        <div class="ibox-content">
                            <h2>Login</h2>
                            <p>
                                Consultar os logins por nome.
                            </p>
                            <form method="post" action="../login/consulta_login.php">
                            <div class="input-group">
                                <input type="text" placeholder="Pesquisar login " class="input form-control" name="txt_pesquisa">
                            ...
                            <?php
							$cmd = "SELECT * FROM tb_login";
							$login = mysqli_query($con, $cmd);
							$total = mysqli_num_rows($login);
							?>
                            <span class="float-right small text-muted"><?php echo $total ?> Logins</span><br>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $dados['LOG_DTCADASTRO'];?></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td><a href="delete.php?LOG_CODIGO=<?php echo $dados['LOG_CODIGO']; ?>"> 
        	                                            <img src="../img/excluir.png"> 
      		                                        </a> </td>
                                                    <td><a href="form_atualizar.php?LOG_CODIGO=<?php echo $dados['LOG_CODIGO']; ?>"> 
