...
$sql = "select tb_vendas.*,tb_clientes.CLI_NOME,tb_tipopagto.TPG_DESCRICAO 
from tb_vendas 
inner join tb_clientes on (tb_vendas.CLI_CODIGO=tb_clientes.CLI_CODIGO)
inner join tb_tipopagto on (tb_vendas.TPG_CODIGO=tb_tipopagto.TPG_CODIGO)
where VEN_CODIGO = (select max(VEN_CODIGO) from tb_vendas)";
...
$sql3 = "select tb_itensvenda.*,tb_produtos.*,tb_vendas.VEN_CODIGO 
from tb_itensvenda 
inner join tb_produtos on (tb_itensvenda.PRO_CODIGO=tb_produtos.PRO_CODIGO) 
inner join tb_vendas on (tb_itensvenda.VEN_CODIGO=tb_vendas.VEN_CODIGO) 
 where tb_itensvenda.VEN_CODIGO = (select max(VEN_CODIGO) from tb_vendas)";
$sql3 = mysqli_query ($con, $sql3) or die ("Erro na sql!");

$sql4 = "select SUM(tb_itensvenda.ITV_QTDE*tb_itensvenda.ITV_VRUNITARIO) AS valortotal
from tb_itensvenda
inner join tb_vendas on (tb_itensvenda.VEN_CODIGO=tb_vendas.VEN_CODIGO) 
where tb_itensvenda.VEN_CODIGO = (select max(VEN_CODIGO) from tb_vendas)";
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
          ...
          <div class="row">
            ...
            <form method="post" style="height:100%;" action="../vendas/add_item_venda.php">
                    
            <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Código</label>
                <div class="col-sm-10"><input type="text" class="form-control" name="txt_codigo" value="<?php echo $dados['VEN_CODIGO'];?>" readonly></div>
            </div>
            <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Cliente</label>
                <div class="col-sm-10"><input type="text" class="form-control" name="txt_cliente" value="<?php echo $dados['CLI_NOME'];?>" readonly></div>
            </div>
            ...
            <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Observação</label>
            	<div class="col-sm-10"><input type="text" class="form-control" name="txt_obs" value="<?php echo $dados['VEN_OBSERVACAO'];?>" readonly></div>
            </div>
                     
            <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Produto</label>
                ...
                <!--Consulta -->
                    <div class="ibox">
                        <div class="ibox-content">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo 'R$ ' .$dados3['ITV_VRUNITARIO'];?></td>
                                                    <td><?php echo $dados3['ITV_QTDE'];?></td>
                                                    <td></td>
                                                    <td><?php echo 'R$ ' .$dados3['ITV_QTDE']*$dados3['ITV_VRUNITARIO'];?></td>
                                                    <td><a href="delete.php?ID=<?php echo $dados3['ITV_CODIGO']; ?>&&venda=<?php echo $dados3['VEN_CODIGO']; ?>"> 
                            ...
                            <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Total da venda</label>
            	                 <div class="col-sm-10"><input type="text" class="form-control" name="txt_totalcompra" value="<?php echo 'R$ ' .$dados4['valortotal'];?>"></div>
                             </div>
                             
                             <div class="col-sm-offset-2" style="float:right;">
                                        
                                    <button class="btn btn-primary btn-sm" type="submit">Finalizar venda</button><br><br>
                                 
                             </div>
                             <input type="hidden" class="form-control" name="txt_codigo" value="<?php echo $dados['VEN_CODIGO'];?>">
                             </form>
                </div>
            </div>
