...
if (!empty($_REQUEST['txt_data']) || !empty($_REQUEST['txt_data2'])) {
        ...
        $sql = "select tb_vendas.*,tb_clientes.CLI_NOME from tb_vendas 
        inner join tb_clientes on (tb_vendas.CLI_CODIGO=tb_clientes.CLI_CODIGO) 
        where VEN_DATA BETWEEN '$pesquisa' AND '$pesquisa2'";

        $sql4 = "select SUM(tb_vendas.VEN_VALOR) AS valortotal 
        from tb_vendas 
        where VEN_DATA BETWEEN '$pesquisa' AND '$pesquisa2'";
                ...
                <div class="col-sm-12">
                    <div class="ibox">
                        <div class="ibox-content">
                            ...
                            <form method="post" action="../vendas/consulta.php">
                            ...
                            <?php
							$cmd = "SELECT * FROM tb_vendas";
							$clientes = mysqli_query($con, $cmd);
							$total = mysqli_num_rows($clientes);
							?>
                            <span class="float-right small text-muted"><?php echo $total ?> Vendas</span><br>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $dados['VEN_VALOR'];?></td>
                                                    <td><?php echo date_format(new DateTime($dados['VEN_DATA']), "d/m/Y");?></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td><a href="delete_venda.php?ID=<?php echo $dados['VEN_CODIGO']; ?>"> 
