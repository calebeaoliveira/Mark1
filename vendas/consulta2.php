...
if (!empty($_REQUEST['txt_pesquisa'])) {
        ...
        $sql4 = "select SUM(tb_vendas.VEN_VALOR) AS valortotal,tb_clientes.CLI_NOME 
        from tb_vendas 
        inner join tb_clientes on (tb_vendas.CLI_CODIGO=tb_clientes.CLI_CODIGO)  
        where CLI_NOME LIKE '%".$pesquisa."%'";
                ...
                <div class="col-sm-12">
                    <div class="ibox">
                        <div class="ibox-content">
                            <h2>Vendas</h2>
                            <p>
                                Consultar as vendas por cliente.
                            </p>
                            <form method="post" action="../vendas/consulta2.php">
                            <div class="input-group">
                            <input type="text" placeholder="Pesquisar vendas " class="input form-control" name="txt_pesquisa">
                    ...
                    <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Total do cliente</label>
