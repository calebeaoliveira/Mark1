    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <a href="#"><i class="fa fa-table"></i> <span class="nav-label">Consultas </span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li>
                            <a href="../pratos/consulta_pratos.php">Itens do Cardápio <span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
          ...
          <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
                <div class="col-lg-12">
                     <form method="post" style="height:100%;" action="../fornecedor/atualizar.php">
            <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Código</label>
            	<div class="col-sm-10"><input type="text" class="form-control" name="txt_codigo" value="<?php echo $dados['FOR_CODIGO'];?>" readonly></div>
            </div>
             <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Nome</label>
            	<div class="col-sm-10"><input type="text" class="form-control" name="txt_nome" value="<?php echo $dados['FOR_NOME'];?>"></div>
            </div>
            <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">CNPJ</label>
            	<div class="col-sm-10"><input type="text" class="form-control" name="txt_cnpj" value="<?php echo $dados['FOR_CNPJ'];?>"></div>
            </div>
            <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Telefone</label>
            	<div class="col-sm-10"><input type="text" class="form-control" name="txt_telefone" value="<?php echo $dados['FOR_TELEFONE'];?>"></div>
            </div>
             <div class="form-group  row" style="margin-top:2%;"><label class="col-sm-2 col-form-label">Observação</label>
            	<div class="col-sm-10"><input type="text" class="form-control" name="txt_observacao" value="<?php echo $dados['FOR_OBSERVACAO'];?>"></div>
            </div>
