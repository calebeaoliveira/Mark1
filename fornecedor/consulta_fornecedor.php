...
if (!empty($_REQUEST['txt_pesquisa'])) {
        ...
        $sql = "select * from tb_fornecedor where FOR_NOME='$pesquisa'";
}
     else {
                ...
                <div class="col-sm-12">
                    <div class="ibox">
                        <div class="ibox-content">
                            <h2>Fornecedor</h2>
                            <p>
                                Consultar os fornecedores por nome.
                            </p>
                            <form method="post" action="../fornecedor/consulta_fornecedor.php">
                            <div class="input-group">
                                <input type="text" placeholder="Pesquisar fornecedor " class="input form-control" name="txt_pesquisa">
                            ...
                            <?php
							$cmd = "SELECT * FROM tb_fornecedor";
							$fornecedor = mysqli_query($con, $cmd);
							$total = mysqli_num_rows($fornecedor);
							?>
                            <span class="float-right small text-muted"><?php echo $total ?> Fornecedores</span><br>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $dados['FOR_OBSERVACAO'];?></td>
                                                    <td></td>
                                                    <td><a href="delete.php?FOR_CODIGO=<?php echo $dados['FOR_CODIGO']; ?>"> 
        	                                            <img src="../img/excluir.png"> 
      		                                        </a> </td>
                                                    <td><a href="form_atualizar.php?FOR_CODIGO=<?php echo $dados['FOR_CODIGO']; ?>"> 
